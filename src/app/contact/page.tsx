export default function Contact(){
    return<>
    <div className="relative flex items-top justify-center min-h-screen bg-white sm:items-center sm:pt-0 p-16">
                ...
                <div className="mt-8 overflow-hidden">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <form
                            ...
                            method="post"
                            className="p-6 flex flex-col justify-center bg-white "
                        >
                            ...
                            <button
                                type="submit"
                                className="mt-3 md:w-32 bg-black  hover:bg-gray-900  text-white font-bold py-3 px-6 rounded-lg transition ease-in-out duration-300"
                            >
                                Submit
                            </button>

                            <p className="leading-relaxed text-base sm:text-xl text-gray-900  mt-8">
