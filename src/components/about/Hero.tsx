...
export default function Hero(){
    ...
    <div
            ...
            >
                <p className="text-xl sm:text-2xl md:text-3xl font-bold text-start mb-4 md:mb-8 ml-4 sm:ml-8">
                    About us
                </p>
            </div>
    <div className='flex justify-between p-8 my-8'>
    ...
    <p className=''>
        ...
        <p className=''>We pride ourselves on maintaining the highest safety standards, adhering to both national and international aviation regulations.
    ...
    <div className="flex-1 max-w-xs rounded-md border-2 shadow-md py-12 px-4">
