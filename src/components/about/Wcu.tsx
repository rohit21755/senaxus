    ...
    return (
        <>
            <div className="p-8 sm:p-12 md:p-16 text-center" style={{
                ...
                <h1 className="font-bold text-3xl sm:text-4xl md:text-5xl lg:text-6xl">Why choose Senaxus?</h1>
                ...
                <div className="border-2 rounded-lg p-4 my-8 md:my-12 flex flex-col md:flex-row justify-between gap-8 shadow-lg">
                    <div className='w-full md:w-1/2 text-start px-6 sm:px-8 md:px-12 pt-8 md:pt-12'>
                        <div className='my-4' data-aos="fade-left" data-aos-offset="200" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="true" data-aos-anchor-placement="top-center">
                    ...
                    <div className='w-full md:w-1/2'>
                        <Image src={wcu} alt='' data-aos="fade-left" data-aos-offset="200" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="true" data-aos-anchor-placement="top-center"/>
                    </div>
                </div>
            </div>
        </>
