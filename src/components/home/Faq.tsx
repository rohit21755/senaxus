...
const FAQAccordion = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      content: 'We provide comprehensive training programs tailored to meet each students needs.'
    },
    {
      id: 3,
      title: 'What extracurricular activities are available for students?',
      content: 'We offer a wide range of extracurricular activities including sports, arts, music, and academic clubs.'
    },
    {
      id: 4,
      title: 'How do you handle food allergies and dietary restrictions?',
      content: 'We maintain a detailed record of all student allergies and dietary requirements, ensuring safe meal preparation and service.'
    },
    {
      id: 5,
      title: 'What is the teacher-to-student ratio at Little Learners Academy?',
      content: 'We maintain small class sizes to ensure individual attention for each student.'
    },
    {
      id: 6,
      title: 'How do you handle discipline and behavior management?',
      content: 'We use positive reinforcement techniques and maintain clear communication with parents.'
    },
    {
      id: 7,
      title: 'How do I apply for admission to Little Learners Academy?',
      content: 'The admission process involves filling out an application form and scheduling an interview.'
    }
  ];
